...
from nets.revise.modules.revise_video_model import ReviseVideoMixedConditionModel
        
class ReviseVideoX2XUnified:
    ...
    def __init__(
        ...
        logging.info(f"Creating ReviseVideoMixedConditionModel from {checkpoint_dir} and {adapter_checkpoint_dir}")

        self.model = ReviseVideoMixedConditionModel.from_pretrained(
