    ...
    def forward(
        ...
        if inputs_embeds is None:
            (
                ...
                input_ids, position_ids, attention_mask, past_key_values, labels, images#None,labels
            )
        ...
        if new_labels is not None:
            loss_weight = calculate_loss_weight(new_labels) if new_labels is not None else None
