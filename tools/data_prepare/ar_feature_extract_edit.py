...
def collate_fn(samples):
    data_dict_item = {
        ...
        "latent_feature_tgt": [item["latent_feature_tgt"] for item in samples],
    }
...
def main(args):
    ...
    for idx, data in tqdm(enumerate(dataloader), total=len(dataloader)):
        ...
        latent_feature_tgt = data["latent_feature_tgt"][0]
        text_emb = data["text_embs"][0]
        frame_num = data["frame_nums"][0]
        answer = "[GEN_VID]"

        data_id = data["ids"][0]
        images = load_video(vid_path, 8)
        ...
        saved_feat = {
            ...
            "prompt": data["prompts"][0],
            "latent_features": data["latent_features"][0],
            "latent_feature_tgt": data["latent_feature_tgt"][0],
